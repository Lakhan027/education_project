...
app = Flask(__name__)
model = pickle.load(open('kkn11.pkl', 'rb'))
model = pickle.load(open('nb_model11.pkl', 'rb'))
model = pickle.load(open('dt_model11.pkl', 'rb'))
model = pickle.load(open('rf_model11.pkl', 'rb'))
model = pickle.load(open('simoid11_model.pkl', 'rb')) 
